...
{   
   // Buffer buf;
    ...
    private PostgreDBManager dbdocMgr= PostgreDBManager.Instance;         
    ...
    {
        //System.out.println(DbName+ "This was Dbname\n");
        ...
        dbdoc = dbdocMgr.CreateDbDoc(DbName);
       //DiskManager.filename = DbName;
//        try
//        {
            //parses doc and insers elements into indexes:
            parser.parseXmlString(xmlText,doc , dbdoc);
//        }
//        catch(Exception e)
//        {
